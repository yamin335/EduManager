...
public class NoticeMainScreen extends AppCompatActivity implements NoticeAdapter.NoticeAdapterListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        expandableList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                if((i == 2) && (i1 == 1) && (l == 1))
                {
                    Intent intent = new Intent(NoticeMainScreen.this, ShowAttendance.class);
                    startActivity(intent);
                }
                if((i == 2) && (i1 == 0) && (l == 0))
                {
                    Intent intent = new Intent(NoticeMainScreen.this, TakeAttendance.class);
                    startActivity(intent);
                    finish();
                }
...
//                Log.d("DEBUG", "heading clicked"+i+"--"+l);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.commit();
            Intent intent = new Intent(NoticeMainScreen.this, LoginScreen.class);
            startActivity(intent);
            finish();
            return true;
        }
