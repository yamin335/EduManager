            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                if(i==6&&i1==0)
                {
                    ...
                    if (drawer.isDrawerOpen(GravityCompat.START))
                    {
                        ...
                        Intent mainIntent = new Intent(ClassResult.this,Fee.class);
                ...
                if(i==6&&i1==1)
                {
                    ...
                    {
                        drawer.closeDrawer(GravityCompat.START);
                        Intent mainIntent = new Intent(ClassResult.this,FeesHistory.class);
                        ClassResult.this.startActivity(mainIntent);
...
//                Log.d("DEBUG", "heading clicked"+i+"--"+l);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent mainIntent = new Intent(ClassResult.this,StudentMainScreen.class);
            ClassResult.this.startActivity(mainIntent);
            finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.commit();
            Intent intent = new Intent(ClassResult.this, LoginScreen.class);
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new FirstExam(), "Mid Exam");
        adapter.addFragment(new FinalExam(), "Final Exam");
        adapter.addFragment(new ClassTest()
                ,"test Exam");
