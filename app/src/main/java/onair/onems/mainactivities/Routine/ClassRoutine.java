            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                if(i==6&&i1==0)
                {
                    ...
                    if (drawer.isDrawerOpen(GravityCompat.START))
                    {
                        ...
                        Intent mainIntent = new Intent(ClassRoutine.this,Fee.class);
                        ClassRoutine.this.startActivity(mainIntent);
                ...
                if(i==6&&i1==1)
                {
                    ...
                    {
                        drawer.closeDrawer(GravityCompat.START);
                        Intent mainIntent = new Intent(ClassRoutine.this,FeesHistory.class);
                         ClassRoutine.this.startActivity(mainIntent);
...
//                Log.d("DEBUG", "heading clicked"+i+"--"+l);
                ...
                if((i == 2) )
                {
                    ...
                    if (drawer.isDrawerOpen(GravityCompat.START)) {
                        drawer.closeDrawer(GravityCompat.START);
                        Intent mainIntent = new Intent(ClassRoutine.this,StudentAttendance.class);
                       ClassRoutine.this.startActivity(mainIntent);
                        finish();
                    }
                }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent mainIntent = new Intent(ClassRoutine.this,StudentMainScreen.class);
            ClassRoutine.this.startActivity(mainIntent);
            finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.commit();
            Intent intent = new Intent(ClassRoutine.this, LoginScreen.class);
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new One(), "Sat");
        adapter.addFragment(new Two(), "Sun");
        adapter.addFragment(new Three(), "Mon");
        adapter.addFragment(new Four(), "Tue");
        adapter.addFragment(new Five(), "Wed");
        adapter.addFragment(new Six(), "Thu");
        adapter.addFragment(new Seven(), "Fri");
