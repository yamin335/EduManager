...
public class AttendanceReportDailyMain extends SideNavigationMenuParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityName = AttendanceReportDailyMain.class.getName();

        LayoutInflater inflater = (LayoutInflater)this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View childActivityLayout = Objects.requireNonNull(inflater).inflate(R.layout.attendance_report_daily_main, null);
        ...
        Button showReport = findViewById(R.id.showReport);
        ...
        datePicker.setOnClickListener(v -> {
            ...
            // date picker dialog
            datePickerDialog = new DatePickerDialog(AttendanceReportDailyMain.this,
        ...
        showReport.setOnClickListener(v -> {
            if(StaticHelperClass.isNetworkAvailable(AttendanceReportDailyMain.this)) {
                ...
                Toast.makeText(AttendanceReportDailyMain.this,"Please check your internet connection!!!",Toast.LENGTH_LONG).show();
            }
        });
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No session found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedSession = new SessionModel();
                }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No shift found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedShift = new ShiftModel();
                }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No medium found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedMedium = new MediumModel();
                    selectedClass = new ClassModel();
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No class found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedClass = new ClassModel();
                    selectedDepartment = new DepartmentModel();
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No department found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedDepartment = new DepartmentModel();
                    selectedSection = new SectionModel();
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0) {
                    try {
                        ...
                        Toast.makeText(AttendanceReportDailyMain.this,"No section found !!!",Toast.LENGTH_LONG).show();
                    }
                } else {
                    selectedSection = new SectionModel();
                }
            ...
            finalDisposer.add( observable
                    ...
                    .subscribeWith(new DisposableObserver<String>() {
                        ...
                        public void onError(Throwable e) {
                            dialog.dismiss();
                            Toast.makeText(AttendanceReportDailyMain.this,"Session not found!!! ",
                                    Toast.LENGTH_LONG).show();
                        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent mainIntent = new Intent(AttendanceReportDailyMain.this, TeacherMainScreen.class);
    ...
    private void ShiftDataGetRequest() {
        if (StaticHelperClass.isNetworkAvailable(this)) {
            ...
            Toast.makeText(AttendanceReportDailyMain.this,"Please check your internet connection and select again!!! ",
                    Toast.LENGTH_LONG).show();
        }
    }
