...
public class Tuesday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(UserTypeID==1||UserTypeID==2||UserTypeID==4) {
            ...
            String routineData = "";
            if(bundle != null) {
                routineData = bundle.getString("tuesdayJsonArray");
            }
            ...
            tuesdayRoutineDataGetRequest(Long.toString(shiftID), Long.toString(mediumID),
                    Long.toString(classID), Long.toString(sectionID), Long.toString(departmentID),
                    Long.toString(4), Long.toString(instituteID));
            ...
            try {
                ...
                tuesdayRoutineDataGetRequest(selectedStudent.getString("ShiftID"), selectedStudent.getString("MediumID")
                        ,selectedStudent.getString("ClassID"),selectedStudent.getString("SectionID")
                        ,selectedStudent.getString("DepartmentID"),"4", Long.toString(instituteID));
    ...
    void tuesdayRoutineDataGetRequest(String ShiftID, String MediumID, String ClassID, String SectionID,
