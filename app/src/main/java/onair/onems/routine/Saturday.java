...
public class Saturday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(UserTypeID==1||UserTypeID==2||UserTypeID==4) {
            ...
            String routineData = "";
            if(bundle != null) {
                routineData = bundle.getString("saturdayJsonArray");
            }
            ...
            saturdayRoutineDataGetRequest(Long.toString(shiftID), Long.toString(mediumID),
                    Long.toString(classID), Long.toString(sectionID), Long.toString(departmentID),
                    Long.toString(1), Long.toString(instituteID));
            ...
            try {
                ...
                saturdayRoutineDataGetRequest(selectedStudent.getString("ShiftID"), selectedStudent.getString("MediumID")
                        ,selectedStudent.getString("ClassID"),selectedStudent.getString("SectionID")
                        ,selectedStudent.getString("DepartmentID"),"1", Long.toString(instituteID));
