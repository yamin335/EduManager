...
public class Wednesday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(UserTypeID==1||UserTypeID==2||UserTypeID==4) {
            ...
            wednesdayRoutineDataGetRequest(Long.toString(shiftID), Long.toString(mediumID),
                    Long.toString(classID), Long.toString(sectionID), Long.toString(departmentID),
                    Long.toString(5), Long.toString(instituteID));
            ...
            try {
                ...
                wednesdayRoutineDataGetRequest(selectedStudent.getString("ShiftID"), selectedStudent.getString("MediumID")
                        ,selectedStudent.getString("ClassID"),selectedStudent.getString("SectionID")
                        ,selectedStudent.getString("DepartmentID"),"5", Long.toString(instituteID));
    ...
    void wednesdayRoutineDataGetRequest(String ShiftID, String MediumID, String ClassID, String SectionID,
