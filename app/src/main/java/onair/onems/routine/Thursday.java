...
public class Thursday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(UserTypeID==1||UserTypeID==2||UserTypeID==4) {
            String routineData = getArguments().getString("thursdayJsonArray");
            ...
            thursdayRoutineDataGetRequest();
        }

        return  rootView;
    }

    void thursdayRoutineDataGetRequest() {
        if(StaticHelperClass.isNetworkAvailable(getActivity())) {
            ...
            if(UserTypeID == 3) {
                thursdayRoutineDataGetUrl = getString(R.string.baseUrl)+"/api/onEms/spGetDashClassRoutine/"+ShiftID
                        +"/"+MediumID+"/"+ClassID+"/"+SectionID+"/"+SDepartmentID+"/6/"+InstituteID;
            ...
            thursdayRoutineGetDialog.setTitle("Loading...");
            thursdayRoutineGetDialog.setMessage("Please Wait...");
            thursdayRoutineGetDialog.setCancelable(false);
            thursdayRoutineGetDialog.setIcon(R.drawable.onair);
            thursdayRoutineGetDialog.show();

            StringRequest thursdayRoutineRequest = new StringRequest(Request.Method.GET, thursdayRoutineDataGetUrl,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            thursdayRoutineGetDialog.dismiss();
                        }
            ...
            MySingleton.getInstance(getActivity()).addToRequestQueue(thursdayRoutineRequest);
        } else {
