...
public class Friday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(UserTypeID==1||UserTypeID==2||UserTypeID==4) {
            ...
            String routineData = "";
            if(bundle != null) {
                routineData = bundle.getString("fridayJsonArray");
            }
            ...
            if(UserTypeID == 3) {
                fridayRoutineDataGetRequest(Long.toString(shiftID), Long.toString(mediumID), Long.toString(classID), Long.toString(sectionID), Long.toString(departmentID), Long.toString(7), Long.toString(instituteID));
                ...
                try {
                    ...
                    fridayRoutineDataGetRequest(selectedStudent.getString("ShiftID"), selectedStudent.getString("MediumID")
                            ,selectedStudent.getString("ClassID"),selectedStudent.getString("SectionID")
                            ,selectedStudent.getString("DepartmentID"),"7", Long.toString(instituteID));
