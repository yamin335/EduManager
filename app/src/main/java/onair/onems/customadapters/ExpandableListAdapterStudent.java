...
public class ExpandableListAdapterStudent extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterStudent(Context context, List<ExpandedMenuModel> listDataHeader, HashMap<ExpandedMenuModel, List<String>> listChildData, ExpandableListView mView) {
